...
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'gestionnaire_pi_dockwidget_base.ui'))
...
class GestionnairePiDockWidget(QtWidgets.QDockWidget, FORM_CLASS):
    ...
    def __init__(self, plugin):
        ...
        self.current_color = self.settings.get_color()  # pour garder la dernière couleur
        ...
        # Connexions menu Création Lot PI
        ...
        # Connexions pour la page des paramètres
    ...
    def show_annexe6_menu(self):
        ...
        # Pré-remplissage du champ sortie
    ...
    def run_annexe6_from_ui(self):
        ...
        processor = Annexe6Processor(self.plugin.iface)
        processor.run_custom(
    ...
    def run_creation_lot(self):
        ...
        # Lance le traitement après un court délai pour afficher le message correctement
    ...
    def _start_sync_processing(self):
        try:
            ...
            # Ferme la boîte une fois terminé
            if self.progress_msg:
                self.progress_msg.accept()

            QMessageBox.information(self, "Succès", "Création du lot P.I terminée.")
    ...
    def load_settings(self):
        ...
        self.current_color = self.settings.get_color()  # ✅ recharge
